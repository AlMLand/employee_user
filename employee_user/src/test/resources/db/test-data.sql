...
insert into employees (id, version, address_employee, birthdate, email_id, firstname, lastname, salary, user_id) 
values(1, 0, 1, '1985-06-05', 1, 'test_firstname', 'test_lastname', 5000, 1);
